  ...
  return (
    ...
    isPending ? "pending" : isActive ? "nav-link border-b-2 border-b-white px-5 -mb-0.5 text-white px-5 active" : "nav-link px-5 -mb-0.5 text-white px-5"}>Simulations</NavLink>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                onClick={() => {setIsOpen(!isOpen); lockScroll()}}
                type="button"
                className="burger inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
